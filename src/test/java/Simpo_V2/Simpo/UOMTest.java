...
public class UOMTest extends base {
    Properties prop;
    FileInputStream fis;
    public WebDriver driver;
    private static Logger log = LogManager.getLogger(UOMTest.class.getName());
    ...
    public void LoginToWebSite() throws IOException, InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOf(PR.UOMAdd())).click();
