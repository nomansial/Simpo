...
public class SetupProductCategory extends base {
    Properties prop;
    FileInputStream fis;
    public WebDriver driver;
    private static Logger log = LogManager.getLogger(SetupProductCategory.class.getName());
    @Test
    public void LoginToWebSite() throws IOException, InterruptedException {
        ...
        wait.until(ExpectedConditions.visibilityOf(PR.AddButton())).click();
        wait.until(ExpectedConditions.visibilityOf(PR.Name())).sendKeys("Automation"+prop.getProperty("SignUpBusinessEmail"));
        wait.until(ExpectedConditions.visibilityOf(PR.Save())).click();
